import { StyleSheet, Text, View, Dimensions, TextInput, Button, TouchableOpacity ,PixelRatio , AsyncStorage} from 'react-native';
import LottieView from 'lottie-react-native';
import React, { useState } from 'react';
import { CrearUsuario, insertData ,LoginUsuario} from '../SupaConsult';
                        ...
                        if (credentials.password === credentials.confirmPass){
                            try{
                                ...
                                const dato = {
                                    ...
                                    second_name: credentials.firstLastName,
                                    //correo: credentials.email,
                                    tipo: Usuario,
                                }
                                await insertData('inf_usuarios_t', dato)
